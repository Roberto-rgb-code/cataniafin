// landing-page/src/views/EspecialesList.jsx
...
const EspecialesList = () => {
  ...
  const fetchEspeciales = async () => {
    ...
    try {
      ...
      console.log('Respuesta completa en EspecialesList.jsx:', response.data);
      ...
      setError('Error al obtener los especiales destacados: ' + (error.response?.data?.message || error.message));
  ...
  if (loading) {
    return <div className="flex justify-center items-center min-h-screen">Cargando especiales destacados...</div>;
  }
  ...
  return (
    <div className="especiales-container">
      <header className="section-header">
        ...
        <h1 className="section-title">Nuestros Productos Especiales Destacados</h1>
        ...
        <div className="products-main">
          <div className="products-header">
            <div className="products-count">
              Mostrando {totalProducts} especiales destacados
            </div>
          </div>
          ...
          <div className="especiales-grid">
            {getPaginatedProducts().map((especial) => {
              ...
              return (
                <Link to={`/especiales-destacados/${especial.id}`} key={especial.id} className="especial-card-link">
